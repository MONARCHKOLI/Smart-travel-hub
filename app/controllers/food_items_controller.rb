class FoodItemsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @food_item.update(food_item_params)
        format.html { redirect_to @food_item, notice: "Food item was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to food_items_path, notice: "Food item was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def food_item_params
      params.expect(food_item: [ :motel_id, :name, :price, :prep_time_minutes ])
    end
end
