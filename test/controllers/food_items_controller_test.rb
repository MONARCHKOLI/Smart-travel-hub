...
class FoodItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create food_item" do
    assert_difference("FoodItem.count") do
      post food_items_url, params: { food_item: { motel_id: @food_item.motel_id, name: @food_item.name, prep_time_minutes: @food_item.prep_time_minutes, price: @food_item.price } }
    end
  ...
  test "should update food_item" do
    patch food_item_url(@food_item), params: { food_item: { motel_id: @food_item.motel_id, name: @food_item.name, prep_time_minutes: @food_item.prep_time_minutes, price: @food_item.price } }
